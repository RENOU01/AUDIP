...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-signal-900/95 backdrop-blur border-b border-signal-700">
      <nav className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <NavLink
            to="/login"
            className="ml-2 flex items-center gap-1.5 px-3 py-2 rounded-md text-sm font-medium border border-signal-700 text-slate-300 hover:text-pulse-400 hover:border-pulse-500/50 transition-colors"
          >
            <ShieldCheck size={15} />
            Administración
          </NavLink>
